#+TITLE: Lecturas del Grupo de Lógica Computacional durante el año 2020
#+OPTIONS: ^:nil

Este repositorio es una recopilación de lecturas compartidas en la lista de
correo del [[http://www.glc.us.es][grupo de lógica computacional]] durante el año 2020. La recopilación
...
- [[#julio-de-2020][Julio de 2020]]
  ...
  - [[#23-jul-20][23-Jul-20]]
  - [[#24-jul-20][24-Jul-20]]
  - [[#24-jul-20-1][24-Jul-20]]
  - [[#25-jul-20][25-Jul-20]]
  - [[#25-jul-20-1][25-Jul-20]]
  - [[#26-jul-20][26-Jul-20]]
  - [[#28-jul-20][28-Jul-20]]
  - [[#30-jul-20][30-Jul-20]]
  - [[#31-jul-20][31-Jul-20]]
...
** 31-Dic-20
+ [[https://www.seas.upenn.edu/~lucsil/papers/dmf.pdf][Dijkstra monads forever: termination-sensitive specifications for interaction trees]]. ~ Lucas Silver, Steve Zdancewic. #ITP #Coq
+ [[http://www.cse.chalmers.se/~myreen/cpp2021-bootstrap-myreen.pdf][A minimalistic verified bootstrapped compiler (Proof Pearl)]]. ~ Magnus O. Myreen. #ITP #HOL4
+ [[https://blog.jle.im/entry/advent-of-code-2020.html][Advent of Code 2020: Haskell solution reflections for all 25 days]]. ~ Justin Le (@mstk). #Haskell #FunctionalProgramming
+ [[https://leanpub.com/haskell-cookbook/read][Haskell tutorial and cookbook, Second edition]]. ~ Mark Watson. #eBook #Haskell #FunctionalProgramming
+ [[https://github.com/mark-watson/haskell_tutorial_cookbook_examples][Examples for "Haskell tutorial and cookbook, Second edition"]]. ~ Mark Watson. #Haskell #FunctionalProgramming
+ [[https://onurgumus.github.io/2022/12/26/Functional-Programming.html][Functional programming: Enemy of the state]]. ~ Onur Gümüş (@OnurGumusDev). #FunctionalProgramming

** 30-Dic-20
+ [[https://dev.to/kakkun61/the-simplest-monadfail-instance-2i4e][The simplest MonadFail instance]]. ~ Kazuki Okamoto (@kakkun61). #Haskell #FunctionalProgramming
+ [[https://ro-che.info/articles/2020-12-29-statet-vs-ioref][StateT vs IORef: a benchmark]]. ~ Roman Cheplyaka. #Haskell #FunctionalProgramming

** 29-Dic-20
+ [[https://www.researchgate.net/publication/347964119_Irrationality_and_Transcendence_Criteria_for_Infinite_Series_in_IsabelleHOL][Irrationality and transcendence criteria for infinite series in Isabelle/HOL]]. ~ Angeliki Koutsoukou-Argyraki, Wenda Li, Lawrence Paulson. #ITP #IsabelleHOL #Math
+ [[https://notes.abhinavsarkar.net/2020/aoc-learnings][Learnings from solving Advent of Code 2020 in Haskell]]. ~ Abhinav Sarkar (@abhin4v). #Haskell #FunctionalProgramming
+ [[https://nauths.fr/en/2020/12/27/haskell-type-level-shenanigans.html][Haskell type-level functions shenanigans (An introduction to some useful language extensions)]]. ~ Antoine Leblanc (@nicuveo). #Haskell #FunctionalProgramming
+ [[https://dev.to/kakkun61/ephemeral-purely-functional-data-structure-and-linear-type-489j][Ephemeral purely functional data structure and linear type]]. ~ Kazuki Okamoto (@kakkun61). #Haskell #FunctionalProgramming
+ [[http://kremer.cpsc.ucalgary.ca/courses/seng403/W2013/papers/11ProgrammingLanguages.pdf][Programming language families (Procedural, object oriented, logic, and functional languages)]]. ~ Jobelle Firme, Nicolas Valera, Yunus Canemre, Stephen Burchill, Beenish Khurshid. #Programming

** 28-Dic-20
+ [[https://www.isa-afp.org/browser_info/current/AFP/Delta_System_Lemma/document.pdf][Cofinality and the delta system lemma (in Isabelle)]]. ~ Pedro Sánchez Terraf. #ITP #IsabelleZF #Logic #Math
+ [[https://youtu.be/drYFAEzKJOE][Counting bits with Haskell (The bad and the good way)]]. ~ Flavio Corpa (@FlavioCorpa). #Haskell #FunctionalProgramming
+ [[https://cronokirby.com/posts/2020/12/haskell-in-haskell-3/][(Haskell in Haskell) 3: Parsing]]. ~ Lúcás Meier (@cronokirby). #Haskell #FunctionalProgramming
+ [[https://youtu.be/BQNOjum8YlU][My first type theory]]. ~ Arved Friedemann. #TypeTheory

** 27-Dic-20
+ [[https://doisinkidney.com/posts/2020-12-27-cayley-trees.html][Trees indexed by a Cayley Monoid]]. ~ Donnacha Oisín Kidney (@oisdk). #Haskell #FunctionalProgramming

** 26-Dic-20
+ [[https://github.com/leanprover-community/lean/blob/master/doc/faq.md][Lean prover: Frequently Asked Questions]]. #ITP #LeanProver
+ [[https://blog.ocharles.org.uk/posts/2020-12-23-monad-transformers-and-effects-with-backpack.html][Monad transformers and effects with Backpack]]. ~ Ollie Charles (@acid2). #Haskell #FunctionalProgramming
+ [[https://frasertweedale.github.io/blog-fp/posts/2020-12-21-refactoring-type-classes-optics.html][Refactoring using type classes and optics]]. ~ Fraser Tweedale (@hackuador). #Haskell #FunctionalProgramming
+ [[https://github.com/lucasdicioccio/santa-wrap][Santa Wrap]]. ~ Lucas Di Cioccio (@lucasdicioccio). #Haskell #FunctionalProgramming #MiniZinc
+ [[https://ai.ia.agh.edu.pl/_media/pl:dydaktyka:est:essential_thinking_2020-59.pdf][Essential thinking]]. The art of creative thinking for problem solving. ~ Antoni Ligeza. #ProblemSolving #Prolog #CLP #AI
+ [[https://leanpub.com/hy-lisp-python/read][A Lisp programmer living in Python-land: The Hy programming language]]. ~ Mark Watson (@mark_l_watson). #eBook #Lisp #Python #Programmig
+ [[http://www.math.ac.vn/training/images/TTDaotao/VinIF/Laptrinh_TNTrung.pdf][Python programming and scientific computation]]. ~ Tran Nam Trung. #eBook #Python #Programming
+ [[https://republicaweb.es/podcast/descubriendo-la-programacion-funcional-elixir-con-erick-navarro/][Descubriendo la programación funcional: Elixir con Erick Navarro (@erickgnavar)]]. #Elixir #ProgramaciónFuncional vía @republicawebes
